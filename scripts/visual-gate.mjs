...
const routes = [
  { path: "/", slug: "root", direction: "machined-night", checkpoints: ["top", "services", "diagnostic-photo", "standards", "reviews", "google-reviews", "team", "craft-photo", "faq", "location", "source-pages"] },
  { path: "/shade", slug: "shade", direction: "shade-tree-service", checkpoints: ["shade-top", "shade-services", "shade-reference", "shade-standard", "shade-family-title", "shade-capability-photo", "shade-reviews", "shade-google-reviews", "shade-location"] },
];
const viewports = [
